...
if($('html').attr('lang') === 'fa')
{
	Highcharts.setOptions(
	{
		lang:
		{
			contextButtonTitle: "ãäæ? äãæÏÇÑ",
			decimalPoint: ",",
			downloadCSV: "ÏÇäáæÏ Ó?ÇÓæ?",
			downloadJPEG: "ÏÇäæáÏ ÊÕæ?Ñ Ì??Ì?",
			downloadPDF: "ÏÇäáæÏ ?Ï?ÇÝ",
			downloadPNG: "ÏÇäáæÏ ÊÕæ?Ñ ?ÇäÌ?",
			downloadSVG: "ÏÇäáæÏ ÇÓæ?Ì?",
			downloadXLS: "ÏÇäáæÏ Ç˜Óá",
			drillUpText: "ÈÇÒ˜ÔÊ Èå  {series.name}",
			invalidDate: "ÊÚÑ?Ý äÔÏå",
			loading: "ÏÑ ÍÇá  ÈÇÑÐÇÑ?",
			months: ["ŽÇäæ?å", "ÝæÑ?å", "ãÇÑ", "ÂÑ?á", "ã?", "Ìæä", "ÌæáÇ?", "ÂæÓÊ", "ÓÊÇãÈÑ", "Ç˜ÊÈÑ", "äæÇãÈÑ", "ÏÓÇãÈÑ"],
			noData: "ÏÇÏåÇ? ÈÑÇ? ÑÓã æÌæÏ äÏÇÑÏ",
			printChart: "",
			resetZoom: "",
			resetZoomTitle: "",
			thousandsSep: "",
